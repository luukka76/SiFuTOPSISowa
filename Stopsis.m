function [CCS,Sstar,Sneg,Order]=Stopsis(WD,FDM,k,m,n,ideal,criteria,simi,alpha1,alpha2)
% Where for inputs:
% 
...
%Aggregating over the criterias using owa:
%Weights for positive ideal:
wplus=Rim1(n,alpha1);
%Similarities aggregated using owa weights:
SstarAgg=owamatrix(Sstar,wplus);
Sstar=SstarAgg';
...
%Sneg=SnegAgg';
%Aggregating over the criterias using owa:
wminus=Rim1(n,alpha2);
SnegAgg=owamatrix(Sneg,wminus);
Sneg=SnegAgg';
